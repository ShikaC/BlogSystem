...
import { getAdminComments, updateCommentStatus, deleteComment, batchDeleteComments } from '@/api/admin'
...
const loadComments = async () => {
  loading.value = true
  try {
    const res = await getAdminComments({ status: status.value, page: page.value, size: pageSize.value })
