...
public interface ArticleRepository extends JpaRepository<Article, Long> {
        ...
        Page<Article> findByCategory_IdAndStatusOrderByIsTopDescCreatedAtDesc(Long categoryId, Integer status,
                        Pageable pageable);
        ...
        // 根据用户和状态查询
        Page<Article> findByUser_UsernameAndStatusOrderByCreatedAtDesc(String username, Integer status,
                        Pageable pageable);
