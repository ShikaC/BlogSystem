...
export const warnUser = (postId, message) => request.post(`/admin/forum/posts/${postId}/warn`, { message })
export const disableUser = (postId) => request.post(`/admin/forum/posts/${postId}/disable-user`)
export const warnUserByComment = (commentId, message) => request.post(`/admin/comments/${commentId}/warn`, { message })
export const disableUserByComment = (commentId) => request.post(`/admin/comments/${commentId}/disable-user`)
