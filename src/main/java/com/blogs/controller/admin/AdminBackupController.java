...
public class AdminBackupController {
    ...
    public ResponseEntity<byte[]> exportArticlesAsMarkdown() throws IOException {
        ...
        String fileName = "articles_md_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")) + ".zip";
    ...
    public ResponseEntity<byte[]> exportArticlesAsHtml() throws IOException {
        ...
        String fileName = "articles_html_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")) + ".zip";
    ...
    public ResponseEntity<byte[]> exportComments() throws IOException {
        ...
        String fileName = "comments_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")) + ".json";
    ...
    public ResponseEntity<byte[]> exportAllData() throws IOException {
        ...
        String fileName = "blog_backup_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")) + ".zip";
